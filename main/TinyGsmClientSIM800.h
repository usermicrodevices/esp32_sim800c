...
public:
  ...
  GsmClient(TinyGsmSim800& modem, uint8_t mux = 0) {
    init(&modem, mux);
  }
...
public:
  ...
  GsmClientSecure(TinyGsmSim800& modem, uint8_t mux = 0)
    : GsmClient(modem, mux)
  {}
...
#else
      // while (!stream.available()) {vTaskDelay(500 / portTICK_RATE_MS);}
